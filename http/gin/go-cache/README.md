Go-cache, Go dili için bir çerez (cache) yöneticisi paketidir. Bu paket, verilerin bellekte tutulmasını ve sonraki isteklerde bu verilere hızlı bir şekilde erişebilmeyi amaçlar.
